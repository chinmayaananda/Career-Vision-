...
// Generic function to render Lucide-like icons based on string name from constants
export const DynamicIcon = ({ name, className = "" }: { name: string; className?: string }) => {
  ...
  switch(name) {
    case 'plane': return <svg {...props}><path d="M2 12h20"/><path d="M13 2l9 10-9 10"/><path d="M2 12l5-5m0 10l-5-5"/></svg>; // Abstracted
    ...
    case 'stethoscope': return <svg {...props}><path d="M6 5v11a5 5 0 0 0 10 0V5"/><path d="M8 3v2"/><path d="M14 3v2"/><circle cx="12" cy="20" r="2"/></svg>; // Abstract
    case 'medal': return <svg {...props}><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>;
    ...
    case 'cloud-lightning': return <svg {...props}><path d="M19 16.9A5 5 0 0 0 18 7h-1.26a8 8 0 1 0-11.62 9"/><polyline points="13 11 9 17 15 17 11 23"/></svg>;
    ...
    case 'sword': return <svg {...props}><polyline points="14.5 17.5 3 6 3 3 6 3 17.5 14.5"/><line x1="13" y1="19" x2="19" y2="13"/><line x1="16" y1="16" x2="20" y2="20"/><line x1="19" y1="21" x2="21" y2="19"/></svg>;
